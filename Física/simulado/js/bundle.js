...
module.exports={
	"questoes": [
		{
			"enunciado": "1) (UESPI) – Um bloco de 2 Kg é puxado com velocidade constante por uma distância de 4 m em um piso horizontal por uma corda que exerce uma força de 7 N fazendo um ângulo de 60º acima da horizontal. Sabendo que Cos(60º) = 0,5 e Sen(60º) = 0,86, o trabalho executado pela corda sobre o bloco é de:",
			"alternativas": [
				"14,0 J",
				"24,0 J",
				"28,0 J",
		...
		{
			"enunciado": "3) Há vários tipos de tratamentos de doenças cerebrais que requerem a estimulação de partes do cérebro por correntes elétricas. Os eletrodos são introduzidos no cérebro para gerar pequenas correntes em áreas específicas. Para se eliminar a necessidade de introduzir eletrodos no cérebro, uma alternativa é usar bobinas que, colocadas fora da cabeça, sejam capazes de induzir correntes elétricas no tecido cerebral. <br> <br>Para que o tratamento de patologias cerebrais com bobinas seja realizado satisfatoriamente, é necessário que:",
			"alternativas": [
				"Haja um grande número de espirais nas bobinas, o que diminui a voltagem induzida.",
		...
		{
			"enunciado": "4) Um corpo total ou parcialmente submerso em um fluido, em equilíbrio, e sob a ação da gravidade, recebe a ação de uma força vertical de sentido oposto à força da gravidade. Com base na informação, assinale a alternativa correta.",
			"alternativas": [
		...
		{
			"enunciado": "6) A energia térmica (ou calor) é a energia em trânsito que ocorre única e exclusivamente devido a uma diferença de temperatura. Ela pode ocorrer nos sólidos, nos líquidos e nos gases, basicamente por meio de três mecanismos de transferência. A esse respeito, afirma-se que",
			"alternativas": [
		...
		{
			"enunciado": "7) Uma partícula de massa m se desloca com velocidade v. A partir de certo instante, essa partícula passa a se mover com o dobro dessa velocidade. Em relação à energia cinética dessa partícula, assinale a alternativa correta.",
			"alternativas": [
				"A energia cinética da partícula é reduzida a um quarto de seu valor original.",
				"A energia cinética da partícula é reduzida oito vezes.",
				"A energia cinética da partícula torna-se quatro vezes maior que seu valor original.",
				"A energia cinética da partícula não se altera.",
				"A energia cinética da partícula aumenta em oito vezes."
			],
			"resposta": "0",
			"marcada": ""
		},
		{
			"enunciado": "8) ENEM(2020) Há muitos mitos em relação a como se proteger de raios, cobrir espelhos e não pegar em facas, garfos e outros objetos metálicos, por exemplo. Mas, de fato, se houver uma tempestade com raios, alguns cuidados são importantes, como evitar ambientes abertos. Um bom abrigo para proteção é o interior de um automóvel, desde que este não seja conversível.",
			"alternativas": [
				"Isolamento elétrico dos pneus.",
				"O Efeito de para-raios da antena.",
				"O Blindagem pela carcaça metálica.",
				"O Escoamento da água pela lataria.",
				"O Aterramento pelo fio terra da bateria."
			],
			"resposta": "2",
			"marcada": ""
		},
		{
			"enunciado": "9) Um motor só poderá realizar trabalho se receber uma quantidade de energia de outro sistema. No caso, a energia armazenada no combustível é, em parte, liberada durante a combustão para que o aparelho possa funcionar. Quando o motor funciona, parte da energia convertida ou transformada na combustão não pode ser ultilizada para a realização de trabalho. Isso significa dizer que há vazamento da energia em outra forma. <br> <br> De acordo com o texto, as transformações de energia que ocorrem durante o funcionamento do motor são decorrrente da:",
			"alternativas": [
